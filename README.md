...
Messenger — веб-приложение для обмена сообщениями с авторизацией, личными и групповыми чатами, избранным, ролями участников, профилями, WebSocket-сообщениями и адаптивным интерфейсом со светлой и темной темами.
